...
function cycle_2() {
  ...
  setTimeout(cycle_3, wait);
}

function cycle_3() {
  images_3[index_3].style.opacity = 0;
  index_3 = (index_3 + 1) % images_3.length;
  images_3[index_3].style.opacity = 1;
  setTimeout(cycle_1, wait);
}
